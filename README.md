...
### Telemetry Evidence
![SIEM Log Analysis](siem_telemetry.png)
...
![Network Packet Capture](network_forensics.png)
...
- [Download Raw Forensic Artifact (ssh_brute_force.pcap)](ssh_brute_force.pcap)
